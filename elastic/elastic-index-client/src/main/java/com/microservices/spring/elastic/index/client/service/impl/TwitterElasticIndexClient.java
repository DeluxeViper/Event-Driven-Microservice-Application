...
import com.microservices.spring.elastic.index.client.util.ElasticIndexUtil;
...
public class TwitterElasticIndexClient implements ElasticIndexClient<TwitterIndexModel> {
    ...
    public List<String> save(List<TwitterIndexModel> documents) {
        ...
        List<String> documentIdsStr = documentIds.stream().map(IndexedObjectInformation::getId).collect(Collectors.toList());
        LOG.info("Documents indexed successfully with type: {} and ids: {}", TwitterIndexModel.class.getName(), documentIdsStr);

        return documentIdsStr;
    }
}
